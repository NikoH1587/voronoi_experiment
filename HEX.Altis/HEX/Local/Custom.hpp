class HEX_CUSTOM
{
	...
	{		
		...
		class FacWest: RscCombo
		{
			...
			w = 10 * GUI_GRID_CENTER_W;
			h = 2 * GUI_GRID_CENTER_H;
			onLBSelChanged = "(_this select 1) call ADM_FNC_FACWEST";
		};			
		...
		class FacEast: RscCombo
		{
			...
			w = 10 * GUI_GRID_CENTER_W;
			h = 2 * GUI_GRID_CENTER_H;
			onLBSelChanged = "(_this select 1) call ADM_FNC_FACEAST";
		};
		...
		class List_West : RscListbox
		{
			...
			onLBSelChanged = "(_this select 1) call ADM_FNC_ADDWEST";
		...
		class Selected_West : RscListbox
		{
			...
			w = 10 * GUI_GRID_CENTER_W;
			h = 18 * GUI_GRID_CENTER_H;
			onLBSelChanged = "(_this select 1) call ADM_FNC_DELETEWEST";
			rowHeight = 1.5 * GUI_GRID_CENTER_H;
		};
		...
		class Selected_East : RscListbox
		{
			...
			w = 10 * GUI_GRID_CENTER_W;
			h = 18 * GUI_GRID_CENTER_H;
			onLBSelChanged = "(_this select 1) call ADM_FNC_DELETEEAST";
			rowHeight = 1.5 * GUI_GRID_CENTER_H;
		};
		...
		class List_East : RscListbox
		{
			...
			w = 10 * GUI_GRID_CENTER_W;
			h = 18 * GUI_GRID_CENTER_H;
			onLBSelChanged = "(_this select 1) call ADM_FNC_ADDEAST";
			rowHeight = 1.5 * GUI_GRID_CENTER_H;
		};
